            ...
            <div class="container-fluid d-flex align-items-center justify-content-between">
                <div class="navbar-header">
                    ...
                    <!-- Navbar Header--><a href="<?php echo base_url(); ?>Admin/Listar" class="navbar-brand">
                        <div class="brand-text brand-big visible"><strong class="text-primary">PASTELERIA</strong><strong class="text-white">ZAZA</strong></div>
                ...
                <div class="right-menu list-inline no-margin-bottom">
                    <h4>Sistema de Venta <strong class="text-primary">ZAZA, <?php echo date("d-M-Y") ?></strong></h4>
                </div>
                <!-- Log out               -->
    ...
    <div class="d-flex align-items-stretch">
        ...
        <nav id="sidebar">
            ...
            <div class="sidebar-header d-flex align-items-center p-1">
                <div class="avatar" data-toggle="modal" data-target="#cambiarPass"><img src="<?php echo base_url(); ?>/Assets/img/avatar.png" alt="..." class="img-fluid rounded-circle"></div>
                <div class="title">
            ...
            <ul class="list-unstyled">
              <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="fas fa-shopping-cart"></i> <strong class="text-white"> Ventas </strong></a>
                ...
                <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="fas fa-shopping-cart"></i> <strong class="text-white"> Reportes </strong></a>
                    <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                        <li><a href="<?php echo base_url(); ?>Reportes/HistorialVentas"> <i class="fas fa-cogs"></i> <strong class="text-white"> Reportes de Ventas </strong></a></li>
                        <li><a href="<?php echo base_url(); ?>Reportes/Estadisticas"> <i class="fas fa-cogs"></i> <strong class="text-white"> Estadisticas </strong></a></li>
                    </ul>
                </li>
