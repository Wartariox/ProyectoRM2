                            ...
                            <tbody>
                                <?php foreach ($data as $lista) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo number_format($lista['total'], 2); // Validación para mostrar total con 2 decimales ?></td>
                                        <td><?php echo date("d-m-Y", strtotime($lista['fecha'])); // Validación para formatear la fecha ?></td>
                                        <td>
